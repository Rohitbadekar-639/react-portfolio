      ...
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          {toggle === 'machine learning' ?
            <ToggleButton active value="machine learning" onClick={() => setToggle('machine learning')}>ARTIFICAL INTELLIGENCE</ToggleButton>
            :
            <ToggleButton value="machine learning" onClick={() => setToggle('machine learning')}>ARTIFICAL INTELLIGENCE</ToggleButton>
          }
        </ToggleButtonGroup>
        <CardContainer>
          {toggle === 'all' && projects
